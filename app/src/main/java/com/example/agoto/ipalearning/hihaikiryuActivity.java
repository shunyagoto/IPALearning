...
public class hihaikiryuActivity extends AppCompatActivity {
    ...
    int currentconma_GX;   //Buttonの左辺座標：X軸
    int currentconma_GY;   //Buttonの上辺座標：Y軸
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conma_Gbutton =(Button) findViewById(R.id.conma_G);
    }
            ...
            Button conma_G = conma_Gbutton;
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_DOWN:
                        ...
                        currentconma_GX = conma_G.getLeft();
                        currentconma_GY = conma_G.getTop();
                    ...
                    case MotionEvent.ACTION_MOVE:
                        ...
                        currentconma_GX -= diffX;
                        currentconma_GY -= diffY;
                        ...
                        conma_G.layout(currentconma_GX, currentconma_GY, currentconma_GX + conma_G.getWidth(),
                                currentconma_GY + conma_G.getHeight());
    ...
    public void onconma_GButtonTapped(View view) {
        flag = true;
